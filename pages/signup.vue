  ...
  <div class="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 py-12">
    <div class="max-w-md mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="text-center mb-8">
        ...
        <p class="text-gray-600">Rejoignez DeleteMyData pour reprendre le contrôle de vos données</p>
      </div>

      <!-- Formulaire d'inscription -->
      <div class="bg-white rounded-xl shadow-lg p-8">
        <form @submit.prevent="handleSignup" class="space-y-6" :class="{ 'opacity-50 pointer-events-none': props.disabled }">
          <!-- Prénom et Nom -->
          ...
          <div class="flex items-start">
            ...
            <div class="ml-3 text-sm">
              <label for="terms" class="text-gray-700">
                J'accepte les 
                <a href="/terms" class="text-blue-600 hover:text-blue-500 underline">conditions d'utilisation</a>
                et la 
          ...
          <div class="flex items-start">
            ...
            <div class="ml-3 text-sm">
              <label for="newsletter" class="text-gray-700">
                Je souhaite recevoir des informations sur les nouvelles fonctionnalités et les mises à jour
              </label>
            </div>
          </div>
          ...
          <button
            type="submit"
            :disabled="isLoading || !isFormValid || props.disabled"
        ...
        <div class="mt-6">
          <div class="text-center mb-4">
            <p class="text-sm text-gray-600">Ou s'inscrire avec</p>
          </div>
...
// Meta tags pour SEO
useHead({
  title: 'Inscription - DeleteMyData',
  meta: [
    {
      name: 'description',
      content: 'Créez votre compte DeleteMyData pour commencer à supprimer vos données personnelles des entreprises. Inscription gratuite et sécurisée.'
    }
  ]
})
...
const handleSignup = async () => {
  ...
  try {
    // Simulation d'inscription (remplacer par votre logique Supabase)
    await new Promise(resolve => setTimeout(resolve, 2000))
    
    success.value = 'Compte créé avec succès ! Vous allez être redirigé...'
